                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead className="bg-muted/50">
                            <tr>
                                <th className="px-4 py-3 text-left text-sm font-medium">{t("bookingNumber")}</th>
                                <th className="px-4 py-3 text-left text-sm font-medium">{t("airCompany")}</th>
                                <th className="px-4 py-3 text-left text-sm font-medium">{t("country")}</th>
                                <th className="px-4 py-3 text-left text-sm font-medium">{t("ticketPrice")}</th>
                                <th className="px-4 py-3 text-left text-sm font-medium">{t("paid")}</th>
                                <th className="px-4 py-3 text-left text-sm font-medium">{t("remaining")}</th>
                                <th className="px-4 py-3 text-left text-sm font-medium">{t("status")}</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y">
                            {transfers.map((transfer) => (
                                <tr key={transfer._id} className="hover:bg-muted/50">
